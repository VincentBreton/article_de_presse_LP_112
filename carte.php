 ...
 * Copyright (C) 2018      Vincent Breton <vincent.breton@presentiel.com>
    ...
    if ($result)
    {
    	...
    	while ($i < $num)
    	{
            ...
            $substitutionarray = array (
                ...
                '__MONTH__'=>$month,
                '__DAY__'=>$day,
		'__INDICATIF__'=>$objp->options_indicatif,
		'__DATEFIN__'=>dol_print_date($objp->datefin),
        ...
        if (empty($mode) || $mode=='card' || $mode=='cardlogin')
        {
            ...
            // Code ajouté par Vincent Breton
	    if (! $mesg) {
		include('vb_carte_pdf.php');
		$mypdf=new vb_carte_pdf($objp->firstname,$objp->lastname,$objp->options_indicatif,$substitutionarray[__DATEFIN__]);
//$mypdf->test();
	    }
	} 
        elseif ($mode == 'label')
